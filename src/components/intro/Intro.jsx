    ...
    <div className="i">
      <div className="i-left">
        <div className="i-left-wrapper">
          ...
          <h1 className="i-name">Gokul R</h1>
          <span className="i-short">Full Stack Web Developer</span>
          ...
          <p className="i-desc">
          I am a Web developer I have good handson experience on building responsive full stack websites.
          </p>
        </div>
        <svg
          width="75"
